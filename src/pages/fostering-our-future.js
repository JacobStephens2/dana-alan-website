      ...
      <Container className="top-space fostering-page">
        ...
        <Col sm={12} md={6} lg={7} xl={6}>
          ...
          <Col sm={12} md={6} lg={7} xl={6}>
            ...
            <Col><StaticImage src="../images/fostering-our-future/sustainability-township-bldg-and-yatch-club-2x3.jpeg" alt="Township building with solar panels" placeholder="blurred" /></Col>
          </Row>
          ...
          <Col sm={12} md={6} lg={7} xl={6}>
            ...
            <Col><StaticImage src="../images/fostering-our-future/diversity-polling-AdobeStock_376145991_Preview.jpeg" alt="Dana profile" placeholder="blurred" /></Col>
          </Row>
          ...
          <Col sm={12} md={6} lg={7} xl={6}>
            ...
            <Col><StaticImage src="../images/fostering-our-future/public-works-2x3.jpg" alt="People tending to young trees" placeholder="blurred" /></Col>
          </Row>
