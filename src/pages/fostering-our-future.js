  ...
  return (
    <div>
      ...
      <Container className="top-space fostering-page">
        ...
        <Row>
        <Col><StaticImage src="../images/fostering-our-future/communication-tent-dana-2x3.jpg" alt="Dana campaigning" placeholder="blurred" /></Col>
        <Col sm={12} md={6} lg={7} xl={6}>
            <h2>Communication</h2>
        ...
        <Row>
          <Col><StaticImage src="../images/fostering-our-future/financial-stability-dana-profile-2x3.jpg" alt="Dana profile photo" placeholder="blurred" /></Col>
          <Col sm={12} md={6} lg={7} xl={6}>
